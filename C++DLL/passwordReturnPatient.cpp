#include"passwordReturnPatient.h"

//connect to MySQL database and return patient's password
const char* returnPasswordPatient(const char* s)
{
	MYSQL mysql;
	MYSQL* ptr = &mysql;
	MYSQL_RES* res;
	...
	{
		std::string option = "select * from idpwpatient where id =";
		option.append(s);
